...
HPS::RelativeOrbitOperator::RelativeOrbitOperator(MouseButtons in_mouse_trigger, ModifierKeys in_modifier_trigger):
    Operator(in_mouse_trigger, in_modifier_trigger), center_of_rotation(Point(0, 0, 0))
{
    selection_options.SetLevel(HPS::Selection::Level::Entity)
...
bool HPS::RelativeOrbitOperator::RelativeOrbitCommon(HPS::WindowPoint const& in_loc, HPS::KeyPath& in_event_path)
{
    ...
    in_event_path.ConvertCoordinate(
        HPS::Coordinate::Space::World, center_of_rotation, HPS::Coordinate::Space::Camera, xform_center_of_rotation);
